...
Ha realizado un pedido a {{ $orden->negocio->nombre_negocio }}.

<div class="info">

				<div class="row mb-4">
					<div>
						<p>Negocio: <strong>{{ $orden->negocio->nombre_negocio }}</strong></p>
					</div>
				</div>
				...
				<div class="row mb-4">
					<div>
						<p>Contacto: <strong>{{ title_case($orden->negocio->nombre) }} {{ title_case($orden->negocio->apellido) }}</strong></p>
					</div>
				</div>
				...
				<div class="row mb-4">
					<div>
						<p>Email: <strong>{{ $orden->negocio->email }}</strong></p>
					</div>
				</div>
				...
				<div class="row mb-4">
					<div>
						<p>Teléfono: <strong>{{ $orden->negocio->telefono }}</strong> <a target="_blank" class="ml-4 btn btn-success" href="https://wa.me/{{ str_slug($orden->negocio->telefono) }}">Comunícate directo por Whatsapp <i class="fa fa-whatsapp"></i></a></p>
					</div>
				</div>
