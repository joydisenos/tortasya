                ...
                <div class="row">
                    <div class="col-md-12">
                        <nav class="navbar navbar-expand-lg navbar-light">
                            ...
                            <img src="images/logo-blanco.svg" class="img-fluid">
                ...
                <span class="icon-menu"></span>
                            ...
                            <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
                                <ul class="navbar-nav">
                                    ...
                                    <li><a href="#" class="btn btn-outline-light top-btn"><span class="ti-user"></span> Ingresar</a></li>
                                </ul>
                            </div>
                        </nav>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="slider-content_wrap">
                                    <h1>Tortas a domicilio online</h1>
                                    <h5 class="text-white">Indicanos tu dirección</h5>
                                </div>
                            </div>
                        </div>
                        <div class="row d-flex justify-content-center">
